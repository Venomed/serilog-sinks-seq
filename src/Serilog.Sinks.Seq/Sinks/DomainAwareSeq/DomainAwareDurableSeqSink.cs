...
namespace Serilog.Sinks.DomainAwareSeq
{
    ...
    /// </summary>
    public sealed class DomainAwareDurableSeqSink : MarshalByRefObject
    {
        private DurableSeqSink _sink;
        ...
        /// String supposed to be generated by LogEvent serialization in DomainAwareDurableSeqSinkProxy and come here across domain boundary.
        /// </summary>
